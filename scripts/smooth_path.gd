...
@export var _smooth: float = 0.0:
	set(value):
		_smooth = smooth(value)
	get:
		return _smooth
@export var _straighten: float = 0.0:
	set(value):
		_straighten = straighten(value)
	get:
		return _straighten
#@export var _smooth setget smooth
#@export var _straighten setget straighten
